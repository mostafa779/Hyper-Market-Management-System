...
public class UpdateProduct extends javax.swing.JFrame {
    ...
    private void getDataFromUser(){
        ...
        this.category = (String)categoryIn.getSelectedItem();
        this.price = Double.parseDouble(priceIn.getText());
        this.quantity = Integer.parseInt(quantityIn.getText());
        this.damages = Integer.parseInt(damagIn.getText());
        this.shortage = Integer.parseInt(shortIn.getText());
